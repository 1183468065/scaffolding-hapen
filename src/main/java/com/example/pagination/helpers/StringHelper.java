package com.example.pagination.helpers;
...
public final class StringHelper {
    ...
    /**
     * <p>Checks if a CharSequence is wuhealthespace, empty ("") or null.</p>
     * <p/>
     * <pre>
     ...
     *
     * @param cs the CharSequence to check, may be null
     * @return {@code true} if the CharSequence is null, empty or wuhealthespace
